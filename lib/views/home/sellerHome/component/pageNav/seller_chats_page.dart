...
class SellerChatsPage extends StatefulWidget {
  ...
  @override
  State<SellerChatsPage> createState() => _SellerChatsPageState();
}

class _SellerChatsPageState extends State<SellerChatsPage> {
  @override
  Widget build(BuildContext context) {
    ...
    List<dynamic> chatUserIds = seller.seller?.chats ?? [];
